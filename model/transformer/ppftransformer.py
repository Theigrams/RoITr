...
from model.transformer.attention import AttentionLayer, AttentionOutput, LocalRPEAttentionLayer, RPEAttentionLayer
from model.transformer.positional_encoding import GeometricStructureEmbedding, PPFStructualEmbedding
            ...
            if block == "self":
                ...
                layers.append(
                    TransformerLayer(
                        ...
                        with_cross_pos_embed=with_cross_pos_embed,
                    )
                )
...
class LocalPPFTransformer(nn.Module):
    def __init__(self, input_dim, output_dim, hidden_dim, num_heads, dropout=None):
        r"""Geometric Transformer (GeoTransformer).
        Args:
            input_dim: input feature dimension
            output_dim: output feature dimension
    ...
    def forward(self, feats, node_idx, group_idx, ppfs):
        r"""Geometric Transformer
        Args:
        ...
        new_feats, _ = self.transformer(feats, pos_embeddings, node_idx, group_idx)
